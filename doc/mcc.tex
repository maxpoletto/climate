...
Then if we let $R$ be the radius of the Earth, the amount of energy absorbed by the Earth is
\[
E_{\text{in}} = S(1-\alpha)\pi R^2
\]

To obtain the average amount of energy per unit area, we divide by the surface area of the Earth:
\[
E_{\text{in}} = \frac{S(1-\alpha)\pi R^2}{4\pi R^2} = \frac{S(1-\alpha)}{4}
\]
